...
export default function InfoDialog(props) {
  ...
  let writeToClipboard = (data) => {
    try {
      ...
      window.prompt(
        'Auto copy to clipboard failed, copy manually from below:',
        data
      );
    }
  };
    ...
    >
      ...
      <DialogContent dividers style={{ maxWidth: 700 }}>
        <Typography gutterBottom>
          Mandelbrot Maps is an interactive fractal explorer built using React
          and WebGL.
        </Typography>
        <Typography gutterBottom>
          Developed by{' '}
          ...
          in 2019/2020 as part of an Honours Project at The University of
          Edinburgh, under the supervision of Philip Wadler.
        </Typography>
        <Typography gutterBottom>
          The project was simultaneously undertaken by Freddie Bawden, also
          under the supervision of Philip Wadler. Freddie's version of the
        ...
        <Typography gutterBottom>
          ...
          <Link href="https://www.shadertoy.com/view/4df3Rn">
            Mandelbrot - smooth
          </Link>{' '}
          by{' '}
